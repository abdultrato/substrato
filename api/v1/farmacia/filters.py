...
class MovimentoEstoqueFilter(django_filters.FilterSet):
    class Meta:
        ...
        fields = ['inquilino', 'id_custom', 'descricao', 'nome', 'ordem', 'ativo', 'deletado', 'deletado_em', 'criado_em', 'atualizado_em', 'criado_por', 'atualizado_por', 'produto', 'lote', 'tipo', 'quantidade']
