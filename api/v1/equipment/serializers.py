...
class MaintenanceSerializer(LegacyAliasSerializerMixin, serializers.ModelSerializer):
    ...
    def get_incident_context(self, obj: Maintenance):
        ...
        return {
            ...
            "equipment_name": self.get_equipment_name(obj),
            "equipment_serial_number": getattr(getattr(incident, "equipment", None), "serial_number", ""),
            "description": incident.description,
            "support_contact": incident.support_contact,
            "post_incident_actions": incident.post_incident_actions,
            "requires_maintenance": incident.requires_maintenance,
            "maintenance_requested_at": incident.maintenance_requested_at,
            "maintenance_completed_at": incident.maintenance_completed_at,
