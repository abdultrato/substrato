...
FILTER_MAP = {
    "cycle_count": CycleCountFilter,
    "cycle_count_line": CycleCountLineFilter,
    "goods_receipt": GoodsReceiptFilter,
    "goods_receipt_line": GoodsReceiptLineFilter,
    "item": WarehouseItemFilter,
    "item_category": WarehouseItemCategoryFilter,
    "lot": WarehouseLotFilter,
    "pick_list": PickListFilter,
    "pick_list_line": PickListLineFilter,
    "purchase_order": PurchaseOrderFilter,
    "purchase_order_line": PurchaseOrderLineFilter,
    "replenishment_plan": ReplenishmentPlanFilter,
    "replenishment_suggestion": ReplenishmentSuggestionFilter,
    "sales_order": SalesOrderFilter,
    "sales_order_line": SalesOrderLineFilter,
    "shipment": ShipmentFilter,
    "shipment_line": ShipmentLineFilter,
    "stock_level": StockLevelFilter,
    "stock_movement": StockMovementFilter,
    "stock_reservation": StockReservationFilter,
    "stock_transfer": StockTransferFilter,
    "stock_transfer_line": StockTransferLineFilter,
    "storage_location": StorageLocationFilter,
