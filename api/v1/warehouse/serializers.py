...
SERIALIZER_MAP = {
    "armazem": WarehouseSerializer,
    "categoriaitem": WarehouseItemCategorySerializer,
    "contagemciclica": CycleCountSerializer,
    "contagemciclicalinha": CycleCountLineSerializer,
    "expedicao": ShipmentSerializer,
    "item": WarehouseItemSerializer,
    "linhaexpedicao": ShipmentLineSerializer,
    "linhaordemcompra": PurchaseOrderLineSerializer,
    "linharecebimento": GoodsReceiptLineSerializer,
    "linhapedidovenda": SalesOrderLineSerializer,
    "linhaseparacao": PickListLineSerializer,
    "linhatransferencia": StockTransferLineSerializer,
    "localizacao": StorageLocationSerializer,
    "lote": WarehouseLotSerializer,
    "movimento": StockMovementSerializer,
    "ordemcompra": PurchaseOrderSerializer,
    "pedidovenda": SalesOrderSerializer,
    "planoreposicao": ReplenishmentPlanSerializer,
    "recebimento": GoodsReceiptSerializer,
    "sugestaoreposicao": ReplenishmentSuggestionSerializer,
    "reserva": StockReservationSerializer,
    "saldo": StockLevelSerializer,
    "separacao": PickListSerializer,
    "transferencia": StockTransferSerializer,
}
