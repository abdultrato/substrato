...
VIEWSET_MAP = {'exame' : ExameViewSet, 'examecampo' : ExameCampoViewSet, 'paciente' : PacienteViewSet, 'requisicaoanalise' : RequisicaoAnaliseViewSet, 'requisicaoitem' : RequisicaoItemViewSet, 'resultadoitem' : ResultadoItemViewSet, }

__all__ = ['ExameViewSet', 'ExameCampoViewSet', 'PacienteViewSet', 'RequisicaoAnaliseViewSet', 'RequisicaoItemViewSet', 'ResultadoItemViewSet', 'VIEWSET_MAP', ]