...
SERIALIZER_MAP = {'exame' : ExameSerializer, 'examecampo' : ExameCampoSerializer, 'paciente' : PacienteSerializer, 'requisicaoanalise' : RequisicaoAnaliseSerializer, 'requisicaoitem' : RequisicaoItemSerializer, 'resultadoitem' : ResultadoItemSerializer, }