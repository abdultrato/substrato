...
class PerfilProfissionalViewSet(ModelViewSet):
    ...
    ordering_fields = ['usuario', 'cargo', 'registro_profissional', 'departamento', 'ativo', 'criado_em', 'atualizado_em']
    ordering = ['-criado_em']
...
class UsuarioViewSet(ModelViewSet):
    ...
    ordering_fields = ['password', 'last_login', 'is_superuser', 'first_name', 'last_name', 'is_staff', 'is_active', 'date_joined', 'email', 'telefone', 'ativo', 'data_criacao']
