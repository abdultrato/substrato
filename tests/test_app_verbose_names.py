...
EXPECTED_VERBOSE_NAMES = {
    ...
    "apps.pathology": "Patologia",
    "apps.payments": "Pagamentos e Gerenciamento Financeiro",
    "apps.pharmacy": "Farmácia e Gestão de Estoque",
    "apps.physiotherapy": "Fisioterapia e Reabilitação",
    "apps.public_health": "Imunização e Saúde Pública",
    "apps.radiology": "Radiologia e Imagiologia",
    "apps.reception": "Recepção e Atendimento ao Paciente",
    "apps.specialty_diagnostics": "Diagnósticos Especializados",
    "apps.surgery": "Cirurgias e Procedimentos Cirúrgicos",
    "apps.telemedicine": "Telemedicina e Monitoramento Remoto",
    "apps.tenants": "Clientes e Unidades Hospitalares",
    "apps.therapy": "Terapias Ocupacionais e Especializadas",
    "apps.transportation": "Transporte e Logística",
    "apps.veterinary": "Medicina Veterinária",
