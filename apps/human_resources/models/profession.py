...
class Profession(CoreModel):
    """Profissão técnica ou ocupacional do funcionário."""
    ...
    professional_category = models.CharField(
        db_column="professional_category",
    ...
    requires_license = models.BooleanField(
        db_column="requires_license",
        verbose_name="Requer licença profissional",
        default=False,
        db_index=True,
    )
    license_authority = models.CharField(
        db_column="license_authority",
        verbose_name="Entidade emissora da licença",
        max_length=120,
        blank=True,
        default="",
    )
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=["tenant", "professional_category"]),
        ]
