    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('DIARIA', 'Diária'), ('SEMANAL', 'Semanal'), ('MENSAL', 'Mensal'), ('SEMESTRAL', 'Semestral'), ('ANUAL', 'Anual')], db_column='type', db_index=True, default='MENSAL', max_length=20)),
                ('scheduled_date', models.DateField(db_column='scheduled_date', db_index=True, default=django.utils.timezone.localdate)),
                ('performed_date', models.DateField(blank=True, db_column='performed_date', db_index=True, null=True)),
                ('description', models.TextField(blank=True, db_column='description', default='')),
                ('technician', models.CharField(blank=True, db_column='technician', default='', max_length=120, verbose_name='Técnico')),
                ...
                ('equipment', models.ForeignKey(db_column='equipment_id', on_delete=django.db.models.deletion.CASCADE, related_name='manutencoes', to='equipamentos.equipment')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['tenant', 'equipment', 'scheduled_date'], name='manutencoes_tenant__2d4cba_idx'), models.Index(fields=['tenant', 'type', 'scheduled_date'], name='manutencoes_tenant__d3b3ac_idx'), models.Index(fields=['tenant', 'performed_date'], name='manutencoes_tenant__d0b56f_idx')],
            },
