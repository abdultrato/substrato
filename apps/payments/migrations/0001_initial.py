...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="pagamentos__referen_ace7b7_idx",
                    ),
                    models.Index(
                        fields=["gateway", "status"],
                        name="pagamentos__gateway_f9701c_idx",
                    ),
                ],
            },
        ),
        ...
        migrations.AddIndex(
            model_name="payment",
            index=models.Index(
                fields=["invoice"], name="pagamentos__fatura__72b132_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="payment",
        ...
        migrations.AddIndex(
            model_name="payment",
            index=models.Index(
                fields=["created_at"], name="pagamentos__criado__c0be10_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="paymenthistory",
            index=models.Index(
                fields=["payment"], name="pagamentos__pagamen_20ed69_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="paymenthistory",
            index=models.Index(
                fields=["event_type"], name="pagamentos__tipo_ev_e0511e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="paymenthistory",
            index=models.Index(
                fields=["created_at"], name="pagamentos__criado__a317e2_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="receipt",
            index=models.Index(
                fields=["invoice", "created_at"], name="pagamentos__fatura__848b6f_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="receipt",
            index=models.Index(fields=["number"], name="pagamentos__numero_ce4052_idx"),
        ),
        migrations.AddIndex(
            model_name="reconciliation",
            index=models.Index(
                fields=["confirmed"], name="pagamentos__confirm_162048_idx"
            ),
        ),
    ]
