...
RESOURCE_LABELS: dict[str, tuple[str, str]] = {
    ...
    "maintenance-manutencao": ("Ordens de manutenção", "Maintenance orders"),
    ...
    "tenants-tenant": ("Inquilinos", "Tenants"),
    "tenants-configuracaoinquilino": ("Configurações de inquilino", "Tenant configurations"),
    "tenants-featureflagtenant": ("Feature flags de inquilino", "Tenant feature flags"),
    "tenants-planoassinatura": ("Planos de assinatura", "Subscription plans"),
    "tenants-usotenant": ("Uso de inquilino", "Tenant usage"),
