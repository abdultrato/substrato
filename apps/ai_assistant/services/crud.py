...
CHOICE_VALUE_ALIASES = {
    ...
    "concluido": ("CON", "COMPLETED", "CONCLUIDA", "CONCLUIDO"),
    "concluida": ("CON", "COMPLETED", "CONCLUIDA", "CONCLUIDO"),
    "concluído": ("CON", "COMPLETED", "CONCLUIDA", "CONCLUIDO"),
    "concluída": ("CON", "COMPLETED", "CONCLUIDA", "CONCLUIDO"),
