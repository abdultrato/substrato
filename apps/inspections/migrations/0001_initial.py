    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "cleaning_performed",
                    models.BooleanField(db_column="cleaning_performed", default=False),
                ),
                (
                    "assessment",
                    models.TextField(blank=True, db_column="assessment", default=""),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="inspecoes_i_tenant__5119b3_idx",
                    ),
                    models.Index(
                        fields=["tenant", "operation_status", "date"],
                        name="inspecoes_i_tenant__d5a81b_idx",
                    ),
                ],
                "constraints": [
