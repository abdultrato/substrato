...
LOCAL_APPS = [
    ...
    "aplicativos.equipamentos.apps.EquipamentosConfig",
    "aplicativos.inspecoes.apps.InspecoesConfig",
    "aplicativos.manutencoes.apps.ManutencoesConfig",
    "aplicativos.ocorrencias.apps.OcorrenciasConfig",
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "seguranca.authenticacao.JWTAuth",
    ],
