...
from nucleo.modelos.base import CoreModel, NoNameCoreModel


class Enfermaria(CoreModel):
    """
...
class CamaEnfermaria(NoNameCoreModel):
    """
...
class InternamentoEnfermaria(NoNameCoreModel):
    """
