...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='atividadeusuario',
            name='usuario',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='auditoria_atividades', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddIndex(
            model_name='atividadeusuario',
