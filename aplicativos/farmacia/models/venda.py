...
class Venda(CoreModel) :
	...
	class Meta :
		...
		indexes = [# Relatórios por período
		...
		constraints = [# Unicidade por inquilino (recomendado SaaS)
			models.UniqueConstraint(fields = ["inquilino", "numero"], condition = Q(deletado = False), name = "unique_numero_venda_por_inquilino", )]
