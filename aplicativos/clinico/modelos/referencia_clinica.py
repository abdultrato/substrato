...
class ReferenciaClinica(CoreModel) :
	...
	sexo = models.CharField(max_length = 10, choices = Genero.choices, null = True, blank = True, help_text = "Se vazio, aplica-se a ambos os sexos.", )
	
	idade_minima_dias = models.PositiveIntegerField(null = True, blank = True, help_text = "Idade mínima em dias.", )
	
	idade_maxima_dias = models.PositiveIntegerField(null = True, blank = True, help_text = "Idade máxima em dias.", )
	...
	class Meta :
		...
		indexes = [models.Index(fields = ["exame_campo"]), models.Index(fields = ["sexo"]), models.Index(fields = ["idade_minima_dias", "idade_maxima_dias"]), ]
	...
	def clean(self) :
		...
		if self.idade_minima_dias is not None and self.idade_maxima_dias is not None and self.idade_minima_dias > self.idade_maxima_dias :
