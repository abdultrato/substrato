...
class ResolverReferenciaClinica :
	...
	def resolver(exame_campo, paciente) :
		...
		if idade is not None :
			referencias = referencias.filter(Q(idade_minima_dias__lte = idade) | Q(idade_minima_dias__isnull = True), Q(idade_maxima_dias__gte = idade) | Q(idade_maxima_dias__isnull = True), )
