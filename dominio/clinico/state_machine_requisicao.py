...
class RequisicaoStateMachine :
	TRANSICOES = {EstadoRequisicao.CRIADA : {EstadoRequisicao.EM_PROCESSAMENTO, EstadoRequisicao.CANCELADA, }, EstadoRequisicao.EM_PROCESSAMENTO : {EstadoRequisicao.AGUARDANDO_VALIDACAO, }, EstadoRequisicao.AGUARDANDO_VALIDACAO : {EstadoRequisicao.VALIDADA, EstadoRequisicao.CANCELADA, }, }
