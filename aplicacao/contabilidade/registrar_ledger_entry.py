...
from aplicativos.contabilidade.modelos.idempotencia_ledger import (
	IdempotenciaLedger
	)
...
from eventos.contabilidade.ledger_entry_criado import (
	LedgerEntryCriado,
	LinhaLedgerDTO,
	)


class OperacaoDuplicadaErro(
		DominioContabilidadeErro,
		):
	pass
