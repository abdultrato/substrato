...
from aplicacao.contabilidade.registrar_ledger_entry import executar as registrar_entry
from aplicativos.contabilidade.modelos.ledger_entry import LedgerEntry
from dominio.contabilidade.excecoes import DominioContabilidadeErro
