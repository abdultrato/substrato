...
export default function PaymentsDetailPage() {
  ...
  const endpointBase = "/payments/payments/";
  ...
  if (!item) return <div>Payments não encontrado</div>;

  return (
    <AppLayout>
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-bold">{item.name || item.title || `Payments #${id}`}</h1>
