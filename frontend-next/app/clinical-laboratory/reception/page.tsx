            ...
            {RECEPTION_COLUMNS.map((col) => {
              ...
              return (
                ...
                >
                  ...
                  {/* cards */}
                  <div className="flex flex-col items-center gap-1.5 overflow-y-auto px-3 pb-3 pl-4 max-h-[calc(100vh-130px)] [scrollbar-width:thin]">
                    {items.length === 0 ? (
