          ...
          <div className="relative flex flex-wrap items-center gap-3 px-4 py-3">
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-1 text-[10px] text-muted-foreground">
                ...
                <span>Formação</span>
                <span>/</span>
                <span className="font-medium text-foreground">Nova formação</span>
              </div>
              <h1 className="text-base font-bold leading-tight text-foreground">
                {title.trim() || "Nova formação"}
              </h1>
        ...
        <div className="grid gap-2 lg:grid-cols-2">
          ...
          <Card icon={BookOpen} title="Identificação" accent="bg-violet-500">
            <Field label="Título da formação" required error={errors.title}>
              <input
                ...
                placeholder="Ex: Biossegurança nível 2 — contenção"
          ...
          <Card icon={User} title="Colaborador" accent="bg-indigo-500">
            <p className="text-[10px] text-muted-foreground pb-0.5">
              Seleccione o colaborador que recebeu a formação.
            </p>
          ...
          <Card icon={Award} title="Formador e certificação" accent="bg-sky-500">
            <Field label="Formador / entidade formadora">
              <input
                ...
                placeholder="Ex: INASA, Cepheid Moçambique, Dr. João…"
                className={inputCls}
              />
            </Field>
            <Field label="Nº do certificado" hint="Deixe em branco se não aplicável.">
              <input
            ...
            <Field label="Competência verificada">
              <label className="flex cursor-pointer items-center gap-2">
                ...
                <span className="text-[11px] text-foreground">
                  Competência do colaborador foi avaliada e verificada
                </span>
              </label>
            </Field>
          </Card>
          ...
          <Card icon={CalendarDays} title="Datas" accent="bg-teal-500">
            ...
            <Field label="Data de validade / expiração" hint="Data a partir da qual a formação requer renovação.">
              <input
          ...
          <div className="lg:col-span-2">
            <Card icon={CheckCircle2} title="Estado — clique para selecionar">
