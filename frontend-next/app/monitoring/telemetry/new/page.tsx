...
const ENDPOINT = "/monitoring/telemetry/";
const LIST_HREF = "/monitoring/telemetry";

export default function MonitoringTelemetryCreatePage() {
  ...
  return (
    <AppLayout requiredGroups={requiredGroupsForResourceGroup("monitoring")}>
      <div className="mx-auto w-full max-w-5xl space-y-4">
        <PageHeader
          title="Nova telemetria"
          subtitle="Registe um evento tecnico e volte para a listagem operacional."
          actions={
            <Link
              href={LIST_HREF}
        ...
        <AutoForm
          ...
          method="post"
          submitLabel="Criar"
          config={getResourceFormConfig("monitoring", "telemetry", ENDPOINT)}
