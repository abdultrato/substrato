...
export default function InvoicesDetailPage() {
  ...
  const endpointBase = "/billing/invoices/";
  ...
  if (!item) return <div>Invoices não encontrado</div>;

  return (
    <AppLayout>
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-bold">{item.name || item.title || `Invoices #${id}`}</h1>
