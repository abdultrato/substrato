  ...
  useEffect(() => {
    ...
    async function load() {
      try {
        ...
        if (!mounted) return
        setErro(isNotFoundLikeError(e) ? null : (e?.message || "Falha ao carregar contas."))
      } finally {
    ...
    () => [
      {
        ...
        render: (c: ContaRow) => (
          <Link
            href={`/resources/accounting/account/${c.id}`}
        ...
        <PageHeader
          ...
          actions={
            <div className="flex flex-wrap items-center gap-2">
              <Link
                href="/resources/accounting/account/new"
              ...
              <Link
                href="/resources/accounting/conta"
