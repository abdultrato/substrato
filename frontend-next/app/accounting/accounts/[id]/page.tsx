...
export default function AccountsDetailPage() {
  ...
  const endpointBase = "/accounting/accounts/";
  ...
  if (!item) return <div>Accounts não encontrado</div>;

  return (
    <AppLayout>
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-bold">{item.name || item.title || `Accounts #${id}`}</h1>
