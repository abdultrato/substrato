                        ...
                        <fieldset className="rounded-2xl border border-border bg-card p-4 shadow-sm">
                            ...
                            <div className="mt-2 grid grid-cols-1 gap-3 md:grid-cols-2">
                                ...
                                <FormField id="raca_origem" label="Raça/origem" hint="Opcional.">
                                    <select id="raca_origem" name="raca_origem" value={form.raca_origem} onChange={handleChange}>
                        ...
                        <fieldset className="rounded-2xl border border-border bg-card p-4 shadow-sm">
                            ...
                            <div className="mt-2 grid grid-cols-1 gap-3 md:grid-cols-2">
                                <FormField id="tipo_documento" label="Tipo de documento" hint="Ex.: BI, Passaporte.">
                                    <select id="tipo_documento" name="tipo_documento" value={form.tipo_documento} onChange={handleChange}>
                        ...
                        <fieldset className="rounded-2xl border border-border bg-card p-4 shadow-sm">
                            ...
                            <div className="mt-2 grid grid-cols-1 gap-3 md:grid-cols-2">
                                ...
                                <FormField id="endereco_pais" label="País" hint="Opcional.">
                                    <select id="endereco_pais" name="endereco_pais" value={form.endereco_pais || ""} onChange={handleChange}>
                        ...
                        <fieldset className="rounded-2xl border border-border bg-card p-4 shadow-sm">
                            ...
                            <div className="mt-2 grid grid-cols-1 gap-3 md:grid-cols-2">
                                <FormField id="proveniencia" label="Proveniência" hint="De onde vem o paciente?">
                                    <select id="proveniencia" name="proveniencia" value={form.proveniencia} onChange={handleChange}>
                                ...
                                <FormField id="empresa_origem" label="Empresa de origem" hint="Obrigatório apenas para Medicina Ocupacional.">
                                    <select
                                        id="empresa_origem"
                                        name="empresa_origem"
