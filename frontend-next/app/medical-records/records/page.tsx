...
import {
  BookOpen, Calendar, ClipboardList, Loader2, Plus, Search, User, X,
} from "lucide-react";
...
function RecordCard({ rec }: { rec: Record_ }) {
    ...
    <Link href={`/medical-records/records/${rec.id}`}
      ...
      <div className="px-4 py-3 pl-5">
        ...
        <div className="grid grid-cols-2 gap-x-4 gap-y-1 text-[11px]">
          ...
          {rec.diagnosis && (
            <div className="col-span-2 truncate text-foreground/70">
        ...
        <section className={`relative ${GLASS}`}>
          ...
          <div className="flex flex-wrap items-end gap-3 px-4 py-3 pl-5">
            ...
            <div className="w-44">
              ...
              <select
                className="w-full rounded-lg border border-border bg-background/60 px-3 py-2 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-violet-500/40 transition"
                value={statusFilter}
...
export default function MedicalRecordsRecordsListPage() {
  return (
