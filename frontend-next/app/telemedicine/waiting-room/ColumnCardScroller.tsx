...
export default function ColumnCardScroller({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="relative">
      ...
      <div
        ref={scrollerRef}
        className="flex touch-pan-x snap-x snap-mandatory items-stretch gap-1 overflow-x-auto scroll-smooth bg-background/25 p-1 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
      >
        {children}
      </div>
      {canRight ? (
