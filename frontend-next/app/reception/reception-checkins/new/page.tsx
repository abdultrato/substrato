...
export default function NewReceptionCheckinPage() {
        ...
        <div className="relative overflow-hidden rounded-xl border border-white/20 bg-white/30 px-4 py-3 shadow-sm backdrop-blur-sm dark:bg-white/5 dark:border-white/10">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-lg font-bold leading-tight text-foreground">Novo check-in</h1>
        ...
        <SectionCard icon={ClipboardList} title="Observações">
          ...
          <Field label="Notas adicionais">
            <textarea value={notes} onChange={(e) => setNotes(e.target.value)}
              rows={4} placeholder="Informações complementares..."
