...
const MODULES: Record<string, CrudMenuItem[]> = {
  ...
  "pathology": [
    { nome: "Pedidos", href: "/pathology/requests", icon: ClipboardCheck },
    { nome: "Recepção de Amostras", href: "/pathology/sample-receptions", icon: FlaskConical },
    { nome: "Acessionamento", href: "/pathology/accessioning", icon: PackageCheck },
    { nome: "Macroscopia", href: "/pathology/grossing", icon: Search },
    { nome: "Processamento", href: "/pathology/processing", icon: Gauge },
    { nome: "Inclusão em Parafina", href: "/pathology/embedding", icon: PackageSearch },
    { nome: "Microtomia", href: "/pathology/microtomy", icon: Scissors },
    { nome: "Histologia", href: "/pathology/histology", icon: Microscope },
    { nome: "Colorações", href: "/pathology/staining", icon: FlaskConical },
    ...
    { nome: "Patologia Molecular", href: "/pathology/molecular", icon: Microscope },
    { nome: "Diagnósticos", href: "/pathology/diagnosis", icon: ClipboardCheck },
    { nome: "Laudos", href: "/pathology/reports", icon: FileText },
    { nome: "Faturação", href: "/pathology/billing", icon: CreditCard },
    { nome: "Inventário", href: "/pathology/inventory", icon: Package },
    { nome: "Controlo de Qualidade", href: "/pathology/quality-control", icon: Settings },
