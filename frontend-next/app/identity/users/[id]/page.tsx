...
export default function UsersDetailPage() {
  ...
  const endpointBase = "/identity/users/";
  ...
  if (!item) return <div>Users não encontrado</div>;

  return (
    <AppLayout>
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-bold">{item.name || item.title || `Users #${id}`}</h1>
