...
export default function ProductsDetailPage() {
  ...
  const endpointBase = "/pharmacy/products/";
  ...
  if (!item) return <div>Products não encontrado</div>;

  return (
    <AppLayout>
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-bold">{item.name || item.title || `Products #${id}`}</h1>
