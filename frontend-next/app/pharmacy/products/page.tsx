  ...
  useEffect(() => {
    ...
    async function load() {
      try {
        setLoading(true)
        setErro(null)
        const { items, meta } = await apiFetchList<ProdutoRow>("/pharmacy/produto/", {
          page,
          pageSize,
        })
    ...
    () => [
      {
        ...
        render: (p: ProdutoRow) => (
          <Link
            href={`/resources/pharmacy/produto/${p.id}`}
        ...
        <PageHeader
          ...
          actions={
            <div className="flex flex-wrap items-center gap-2">
              <Link
                href="/resources/pharmacy/produto/new"
              ...
              <Link
                href="/resources/pharmacy/produto"
