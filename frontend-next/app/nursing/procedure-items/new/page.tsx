  ...
  return (
    <AppLayout requiredGroups={[GROUPS.ADMIN, GROUPS.ENFERMAGEM]}>
      <div className="mx-auto w-full max-w-5xl space-y-3">
        <header className="relative overflow-hidden rounded-2xl border border-white/35 bg-gradient-to-br from-white/30 via-white/12 to-sky-100/20 p-4 shadow-xl shadow-slate-900/5 backdrop-blur-2xl dark:border-white/10 dark:from-white/[0.07] dark:via-white/[0.025] dark:to-sky-950/15">
        ...
        <section className="grid gap-2 sm:grid-cols-3">
          {guidance.map((item) => {
            ...
            return (
              <article
                key={item.title}
                className="flex min-w-0 items-start gap-2.5 rounded-xl border border-white/35 bg-white/20 p-3 shadow-md shadow-slate-900/5 backdrop-blur-xl dark:border-white/10 dark:bg-white/[0.03]"
              >
