    ...
    useEffect(() => {
        ...
        async function load() {
            try {
                setLoading(true)
                setErro(null)
                const { items, meta } = await apiFetchList<PrescricaoItemRow>("/prontuario/prescricaoitem/", {
                    page,
                    pageSize,
                })
        ...
        () => [
            {
                ...
                render: (r: PrescricaoItemRow) => (
                    <Link
                        href={`/recursos/prontuario/prescricaoitem/${r.id}`}
                ...
                <PageHeader
                    ...
                    actions={
                        <div className="flex flex-wrap items-center gap-2">
                            <Link
                                href="/recursos/prontuario/prescricaoitem/novo"
                            ...
                            <Link
                                href="/recursos/prontuario/prescricaoitem"
