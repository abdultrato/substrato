    ...
    useEffect(() => {
        ...
        async function load() {
            try {
                setLoading(true)
                setErro(null)
                const { items, meta } = await apiFetchList<RegistroRow>("/prontuario/registro/", {
                    page,
                    pageSize,
                })
                ...
                if (!mounted) return
                setErro(e?.message || "Falha ao carregar Cardex.")
            } finally {
        ...
        () => [
            {
                ...
                render: (r: RegistroRow) => (
                    <Link
                        href={`/recursos/prontuario/registro/${r.id}`}
                ...
                <PageHeader
                    ...
                    actions={
                        <div className="flex flex-wrap items-center gap-2">
                            ...
                            <Link
                                href="/recursos/prontuario/registro"
