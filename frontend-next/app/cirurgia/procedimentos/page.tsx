    ...
    useEffect(() => {
        ...
        async function load() {
            try {
                setLoading(true)
                setErro(null)
                const { items, meta } = await apiFetchList<ProcRow>("/cirurgia/procedimentocirurgico/", {
                    page,
                    pageSize,
                })
        ...
        () => [
            {
                ...
                render: (p: ProcRow) => (
                    <Link
                        href={`/recursos/cirurgia/procedimentocirurgico/${p.id}`}
                ...
                <PageHeader
                    ...
                    actions={
                        <div className="flex flex-wrap items-center gap-2">
                            <Link
                                href="/recursos/cirurgia/procedimentocirurgico/novo"
