...
export const NAV_ITEMS: NavItem[] = [
    ...
    { href: "/occupational-medicine", label: "Medicina Ocupacional", labelEn: "Occupational Medicine", icon: BriefcaseIcon, desc: "Saúde no trabalho", descEn: "Workplace health", groups: [GROUPS.ADMIN, GROUPS.RECEPCAO, GROUPS.CONTABILIDADE] },
