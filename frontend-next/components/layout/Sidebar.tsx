...
export const NAV_ITEMS: NavItem[] = [
    ...
    { href: "/clinical-pharmacy", label: "Farm. Clínica", labelEn: "Clinical pharmacy", icon: Pill, desc: "IV, controlados e stewardship", descEn: "IV, controlled drugs and stewardship", groups: [GROUPS.ADMIN, GROUPS.FARMACIA] },
