...
export const NAV_ITEMS: NavItem[] = [
    ...
    { href: "/reception", label: "Recepção", labelEn: "Reception", icon: BriefcaseIcon, desc: "Triagem e atendimento", descEn: "Triage and attendance", groups: [GROUPS.ADMIN, GROUPS.RECEPCAO, GROUPS.CONTABILIDADE] },
    ...
    { href: "/consultations", label: "Consultas", labelEn: "Consultations", icon: CalendarClock, desc: "Agenda clínica", descEn: "Clinical schedule", groups: [GROUPS.ADMIN, GROUPS.RECEPCAO, GROUPS.MEDICINA] },
    ...
    { href: "/requests", label: "Requisições", labelEn: "Requests", icon: FileText, desc: "Pedidos clínicos", descEn: "Clinical requests", groups: [GROUPS.ADMIN, GROUPS.RECEPCAO, GROUPS.MEDICINA] },
    ...
    { href: "/clinical-pharmacy", label: "Farmácia Clínica", labelEn: "Clinical pharmacy", icon: Pill, desc: "IV, controlados e stewardship", descEn: "IV, controlled drugs and stewardship", groups: [GROUPS.ADMIN, GROUPS.FARMACIA] },
    { href: "/telemedicine", label: "Telemedicina", labelEn: "Telemedicine", icon: HeartPulse, desc: "Sala virtual e monitoramento remoto", descEn: "Virtual room and remote monitoring", groups: [GROUPS.ADMIN, GROUPS.RECEPCAO, GROUPS.MEDICINA, GROUPS.MEDICINA_OCUPACIONAL, GROUPS.ENFERMAGEM, GROUPS.TELEMEDICINA] },
    ...
    { href: "/occupational-therapy", label: "Terapia Ocupacional", labelEn: "Occupational therapy", icon: HeartPulse, desc: "AVD, função e adaptação", descEn: "ADL, function and adaptation", groups: [GROUPS.ADMIN, GROUPS.RECEPCAO, GROUPS.MEDICINA, GROUPS.MEDICINA_OCUPACIONAL, GROUPS.TERAPIA_OCUPACIONAL] },
    { href: "/physical-therapy", label: "Fisioterapia Especializada", labelEn: "Specialized physio", icon: Activity, desc: "Planos motores especializados", descEn: "Specialized motor plans", groups: [GROUPS.ADMIN, GROUPS.RECEPCAO, GROUPS.MEDICINA, GROUPS.MEDICINA_OCUPACIONAL, GROUPS.FISIOTERAPIA, GROUPS.FONOAUDIOLOGIA] },
    { href: "/radiology", label: "Radiologia", labelEn: "Radiology", icon: Microscope, desc: "Imagem, laudos e PACS", descEn: "Imaging, reports and PACS", groups: [GROUPS.ADMIN, GROUPS.RADIOLOGIA] },
    ...
    { href: "/occupational-medicine", label: "Medicina Ocupacional", labelEn: "Occupational Medicine", icon: BriefcaseIcon, desc: "Saúde no trabalho", descEn: "Workplace health", groups: [GROUPS.ADMIN, GROUPS.RECEPCAO, GROUPS.CONTABILIDADE, GROUPS.MEDICINA_OCUPACIONAL] },
    { href: "/pharmacy", label: "Gestão de Produtos Farmacêuticos", labelEn: "Pharmaceutical Products Management", icon: Pill, desc: "Dispensação e estoque", descEn: "Dispensing and stock", groups: [GROUPS.ADMIN, GROUPS.FARMACIA] },
    ...
    { href: "/pharmacy/material-requests", label: "Requisições de Materiais", labelEn: "Material Requisitions", icon: PackageSearch, desc: "Acompanhar requisições de materiais", descEn: "Track material requisitions", groups: ALL_GROUPS },
...
export default function Sidebar({ user, open = false, onClose, className }: Props) {
                ...
                {section.items.map((item) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <span className="overflow-hidden leading-tight opacity-100 transition-all duration-200 md:max-w-0 md:-translate-x-1 md:opacity-0 md:group-hover/sidebar:max-w-[calc(var(--sidebar-open-width)-3.5rem)] md:group-hover/sidebar:translate-x-0 md:group-hover/sidebar:opacity-100 md:group-focus-within/sidebar:max-w-[calc(var(--sidebar-open-width)-3.5rem)] md:group-focus-within/sidebar:translate-x-0 md:group-focus-within/sidebar:opacity-100">
    ...
    const renderMenu = (navRef: React.RefObject<HTMLElement | null>) => (
        <div className="flex h-full w-full flex-col overflow-hidden border-r border-border bg-transparent text-foreground shadow-none backdrop-blur-md transition-[box-shadow,background-color] duration-200 ease-out md:shadow-md md:group-hover/sidebar:shadow-xl md:group-hover/sidebar:shadow-slate-950/10 md:group-focus-within/sidebar:shadow-xl md:dark:shadow-black/30">
            {/* Mesma altura do header principal (h-11) para as bordas alinharem. */}
            <div className="sticky top-0 z-10 flex h-11 min-h-11 shrink-0 items-center justify-center border-b border-border/80 bg-transparent px-2 py-1.5 backdrop-blur-md transition-colors md:group-hover/sidebar:justify-between md:group-focus-within/sidebar:justify-between">
                <Link
                    href={homeHref}
                    onClick={onClose}
