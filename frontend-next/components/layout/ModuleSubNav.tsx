...
const MODULE_NAVS: ModuleNavConfig[] = [
    ...
    },
    {
        ...
        tabs: [
            ...
            { href: "/clinical-laboratory/molecular", label: "Molecular", labelEn: "Molecular" },
    ...
    },
    {
        ...
        tabs: [
            ...
            { href: "/accounting/financial-reconciliations", label: "Reconciliação financeira", labelEn: "Financial reconciliation" },
            { href: "/accounting/credit-notes", label: "Notas de crédito", labelEn: "Credit notes" },
            { href: "/accounting/account-balances", label: "Saldos", labelEn: "Balances" },
            { href: "/accounting/ledger-entries", label: "Diário", labelEn: "Ledger entries" },
            { href: "/accounting/ledger-lines", label: "Linhas do diário", labelEn: "Ledger lines" },
