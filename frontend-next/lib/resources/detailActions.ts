...
const VETERINARY_DETAIL_ACTIONS: Record<string, DetailActionDefinition[]> = {
  ...
  "/veterinary/lab_request/": [
    { key: "veterinary.lab_request.colher-amostra", action: "colher-amostra", labelPt: "Coletar amostra", labelEn: "Collect sample", successPt: "Amostra coletada.", successEn: "Sample collected.", tone: "primary", fields: [{ name: "sample_identifier", labelPt: "Identificador da amostra (opcional)", labelEn: "Sample identifier (optional)", type: "text" }] },
  ...
  "/clinical/labrequest/": [
    {
      ...
      successPt: "Requisição validada — disponível para coleta.",
    ...
    },
    {
      ...
      labelPt: "Registar coleta",
      labelEn: "Record collection",
      successPt: "Coleta registada — requisição enviada ao laboratório.",
