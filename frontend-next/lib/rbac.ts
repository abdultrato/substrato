...
const GROUP_SYNONYMS: Record<string, string[]> = {
  ...
  Recepcionista: ["recepcionista", "recepcionista de atendimento", "front desk", "check-in", "check in"],
  ...
  "Gestor de RH": ["gestor de rh", "rh", "recursos humanos", "human resources", "hr manager"],
}
