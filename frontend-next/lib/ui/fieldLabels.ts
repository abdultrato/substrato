...
const COMMON_LABELS: LabelsByField = {
  ...
  name: "Nome",
  legal_name: "Designação legal",
  fiscal_address: "Morada fiscal",
  fiscal_phone: "Telefone (fiscal)",
  fiscal_email: "E-mail (fiscal)",
  license_number: "Alvará / Licença",
  health_unit_registration: "Registo da unidade sanitária/laboratório",
  ...
  companion_relationship: "Parentesco do acompanhante",
  companion_contact: "Contacto do acompanhante",
  companion_email: "Email do acompanhante",
  nome_acompanhante: "Nome do acompanhante",
  parentesco_acompanhante: "Parentesco do acompanhante",
  telefone_acompanhante: "Telefone do acompanhante",
  contacto_acompanhante: "Contacto do acompanhante",
  email_acompanhante: "Email do acompanhante",
  address: "Endereço",
  address_street: "Rua",
  ...
  sectors: "Sectores",
  sector_name: "Sector",
  sector_code: "Código do sector",
  reason: "Motivo",
  arrived_at: "Chegada em",
  called_at: "Chamado em",
  ...
  tests: "Exames",
  test: "Exame",
  requested_tests: "Exames solicitados",
  package_price: "Preço do pacote",
  profile_type: "Tipo de perfil",
  occupation: "Função / tipo de trabalho",
  requires_fasting: "Exige jejum",
  ...
  collection_guidance: "Guia de colheita",
  items: "Itens",
  is_occupational: "Requisição ocupacional",
  occupational_profile: "Perfil profissional (bandeja de exames)",
  occupational_profile_name: "Perfil profissional",
  requesting_company: "Empresa solicitante",
  requesting_company_name: "Nome da empresa solicitante",
  ...
  analyst: "Analista",
  requires_consent: "Exige consentimento",
  ...
  treatment_plan_title: "Plano dentário",
  patient_assignment_count: "Pacientes com plano",
  item_count: "Itens",
  assigned_at: "Atribuído em",
  valid_from: "Início da vigência",
  valid_until: "Fim da vigência",
  is_valid: "Plano válido",
  is_expired: "Plano expirado",
  validity_status: "Vigência",
  ...
  salary_allowances_value: "Abonos salariais",
  salary_increase: "Aumento salarial",
  salary_increase_value: "Valor do aumento salarial",
  total_salary: "Salário total",
  ordinary_hour_value: "Valor da hora ordinária",
  extraordinary_hour_value: "Valor da hora extraordinária",
  base_month_hours: "Horas base (mês)",
  minimum_progression_months: "Meses mínimos de progressão",
  ...
  role: "Cargo",
  nuit: "NUIT",
  nib: "NIB / Conta bancária",
  inss_number: "Número INSS",
  ...
  salary_grade: "Nível salarial",
  responsibilities: "Responsabilidades",
  professional_category: "Categoria profissional",
  requires_license: "Requer licença",
  license_authority: "Entidade emissora da licença",
  is_dependent: "É dependente",
  is_emergency_contact: "É contacto de emergência",
  benefit_eligible: "Elegível para benefícios",
  lives_with_employee: "Vive com o funcionário",
  schedule_type: "Tipo de horário",
  shift_name: "Nome do turno",
  effective_from: "Vigente a partir de",
  ...
  vacation_year: "Ano das férias",
  total_days: "Total de dias",
  approved_by: "Aprovado por",
  approved_at: "Aprovado em",
  overtime_type: "Tipo de hora extra",
  hearing_date: "Data da audiência",
  incident_date: "Data do incidente",
  incident_type: "Tipo de incidente",
  action_taken: "Ação aplicada",
  clock_in: "Hora de entrada",
  clock_out: "Hora de saída",
  expected_start: "Entrada prevista",
  expected_end: "Saída prevista",
  late_minutes: "Minutos de atraso",
  early_leave_minutes: "Minutos de saída antecipada",
  worked_hours: "Horas trabalhadas",
  permission_date: "Data da dispensa",
  paid_permission: "Dispensa remunerada",
  deduct_from_hours: "Descontar das horas",
  entitled_days: "Dias com direito",
  used_days: "Dias utilizados",
  pending_days: "Dias pendentes",
  remaining_days: "Dias restantes",
  carried_over_days: "Dias transitados",
  contract_type: "Tipo de contrato",
  is_current: "Salário atual",
  effective_until_label: "Vigente até",
  payroll_period: "Período da folha",
  total_gross: "Total bruto",
  total_deductions: "Total de descontos",
  total_net: "Total líquido",
  payroll_run: "Folha de período",
  overtime_amount: "Horas extras",
  absence_deductions: "Descontos por faltas",
  other_deductions: "Outros descontos",
  gross_pay: "Salário bruto",
  net_pay: "Salário líquido",
  tenure_months: "Meses de antiguidade",
  can_progress_salary: "Pode progredir",
  can_change_career: "Pode mudar de carreira",
  has_open_disciplinary_process: "Processo disciplinar aberto",
