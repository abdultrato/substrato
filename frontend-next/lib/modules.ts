...
const RESOURCE_LABEL_PT_BY_KEY: Record<string, string> = {
  ...
  // Laboratório Clínico (LIS) — recursos descobertos via OpenAPI sem entrada curada.
  ...
  critical_notification: "Notificações de Resultados Críticos",
  culture: "Culturas",
  decontamination: "Descontaminações",
  exposure_incident: "Incidentes de Exposição",
  hazard: "Perigos Biológicos",
  internal_audit: "Auditorias Internas",
  isolate: "Isolados",
  management_review: "Revisões pela Gestão",
  molecular_result: "Resultados Moleculares",
  nonconformity: "Não Conformidades",
  order: "Pedidos",
  order_item: "Itens de Pedido",
  panel: "Painéis de Análises",
  ppe: "EPIs",
  ppe_distribution: "Distribuições de EPI",
  quality_document: "Documentos da Qualidade",
  quality_indicator: "Indicadores da Qualidade",
  reception: "Recepção de Amostras",
  rejection: "Rejeições de Amostras",
  report: "Laudos",
  result: "Resultados",
  ...
  waste: "Resíduos",
  worklist: "Listas de Trabalho",
  // Autenticação / adesão / identidade
  language: "Idioma",
