...
const MODULES_BASE: ModuleGroup[] = [
  ...
  },
  {
    ...
    resources: [
      ...
      { key: "agenda_cirurgica", label: "Agenda Cirúrgica", endpoint: "/surgery/agenda_cirurgica/", adminListHref: "/admin/cirurgia/surgicalschedule/" },
      { key: "centro_cirurgico", label: "Centro Cirúrgico", endpoint: "/surgery/centro_cirurgico/", adminListHref: "/admin/cirurgia/operatingroom/" },
      { key: "equipa_cirurgica", label: "Equipa Cirúrgica", endpoint: "/surgery/equipa_cirurgica/", adminListHref: "/admin/cirurgia/surgicalteammember/" },
      { key: "anestesia", label: "Anestesia", endpoint: "/surgery/anestesia/", adminListHref: "/admin/cirurgia/anesthesiarecord/" },
      { key: "checklist_seguranca", label: "Checklist de Segurança", endpoint: "/surgery/checklist_seguranca/", adminListHref: "/admin/cirurgia/surgicalsafetychecklist/" },
      { key: "materiais", label: "Materiais Cirúrgicos", endpoint: "/surgery/materiais/", adminListHref: "/admin/cirurgia/surgicalmaterial/" },
      { key: "consumos", label: "Consumos Cirúrgicos", endpoint: "/surgery/consumos/", adminListHref: "/admin/cirurgia/surgicalconsumption/" },
      { key: "recuperacao", label: "Recuperação", endpoint: "/surgery/recuperacao/", adminListHref: "/admin/cirurgia/recoveryrecord/" },
      { key: "relatorio_operatorio", label: "Relatório Operatório", endpoint: "/surgery/relatorio_operatorio/", adminListHref: "/admin/cirurgia/operativereport/" },
    ],
  },
  {
    key: "human_resources",
...
const ADMIN_LIST_BY_ENDPOINT: Record<string, string> = {
  ...
  "/surgery/agenda_cirurgica/": "/admin/cirurgia/surgicalschedule/",
  "/surgery/centro_cirurgico/": "/admin/cirurgia/operatingroom/",
  "/surgery/equipa_cirurgica/": "/admin/cirurgia/surgicalteammember/",
  "/surgery/anestesia/": "/admin/cirurgia/anesthesiarecord/",
  "/surgery/checklist_seguranca/": "/admin/cirurgia/surgicalsafetychecklist/",
  "/surgery/materiais/": "/admin/cirurgia/surgicalmaterial/",
  "/surgery/consumos/": "/admin/cirurgia/surgicalconsumption/",
  "/surgery/recuperacao/": "/admin/cirurgia/recoveryrecord/",
  "/surgery/relatorio_operatorio/": "/admin/cirurgia/operativereport/",
  // Pathology
