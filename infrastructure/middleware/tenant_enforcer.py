...
from infrastructure.context.tenant import clear_tenant, get_tenant, set_tenant
...
class TenantEnforcerMiddleware:
    ...
    def _get_tenant_id_from_request(self, request) -> bool:
        ...
        return any(path.startswith(pattern) for pattern in self.TENANT_REQUIRED_PATTERNS)
