...
class StatusModel(models.Model) :
	...
	deletado_por = models.ForeignKey(settings.AUTH_USER_MODEL, null = True, blank = True, on_delete = models.SET_NULL, related_name = "%(class)s_deletado_por", )
...
class AuditTimestampModel(models.Model) :
	...
	criado_por = models.ForeignKey(settings.AUTH_USER_MODEL, null = True, blank = True, on_delete = models.SET_NULL, related_name = "%(class)s_criado_por", )
	
	atualizado_por = models.ForeignKey(settings.AUTH_USER_MODEL, null = True, blank = True, on_delete = models.SET_NULL, related_name = "%(class)s_atualizado_por", )
...
class CoreModel(StatusModel, AuditTimestampModel, CodigoMixin, NomeMixin, OrdemMixin, DescricaoMixin, InquilinoMixin, models.Model, ) :
	"""
	...
	class Meta :
		abstract = True
		indexes = [models.Index(fields = ["ativo"]), models.Index(fields = ["deletado"]), ]
...
class InqCoreModel(StatusModel, AuditTimestampModel, CodigoMixin, NomeMixin, OrdemMixin, DescricaoMixin, models.Model, ) :
	"""
...
class NoNameCoreModel(StatusModel, AuditTimestampModel, CodigoMixin, OrdemMixin, DescricaoMixin, InquilinoMixin, models.Model, ) :
	"""
	Modelo base corporativo.
	"""
