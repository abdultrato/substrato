...
class AuditoriaModel(AuditoriaMixin, VersionamentoMixin, BaseModel) :
	...
	class Meta :
		abstract = True
		indexes = [models.Index(fields = ["versao"]), ]
...
class SoftDeleteModel(SoftDeleteMixin, BaseModel) :
	...
	class Meta :
		abstract = True
		indexes = [models.Index(fields = ["deletado"]), ]
...
class CoreModel(NomeMixin, IdentificadorMixin, AuditoriaMixin, VersionamentoMixin, SoftDeleteMixin, InquilinoMixin, BaseModel, ) :
	"""
...
class InqCoreModel(IdentificadorMixin, AuditoriaMixin, VersionamentoMixin, SoftDeleteMixin, BaseModel, ) :
	"""
...
class NoNameCoreModel(IdentificadorMixin, AuditoriaMixin, VersionamentoMixin, SoftDeleteMixin, InquilinoMixin, BaseModel, ) :
	"""
