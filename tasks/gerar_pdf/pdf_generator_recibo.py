...
def gerar_pdf_recibo(recibo, request=None) -> tuple[bytes, str]:
    """
    ...
    # ESTILOS
    # ==========================
    style_title = estilo_titulo_documento("HeadingRec")
    style_section = estilo_secao_documento("section_rec")
