...
def _resolve_document_user(fatura, requisicao):
    return (
...
def generate_invoice_pdf(fatura, request=None) -> tuple[bytes, str]:
    """
    ...
    usuario_documento = _resolve_document_user(fatura, requisicao)
    ...
    data_requisicao = _format_request_date(requisicao)
...
gerar_pdf_fatura = generate_invoice_pdf
