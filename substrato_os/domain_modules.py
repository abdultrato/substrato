...
INSTALLED_DOMAIN_APP_CONFIGS = (
    ...
    "apps.cotacoes.apps.CotacoesConfig",
...
DOMAIN_MODULES = (
    ...
    DomainModuleDefinition(
        key="administration.quotations",
        domain="administration",
        app_config="apps.cotacoes.apps.CotacoesConfig",
        description="Commercial quotation lifecycle and conversion to invoices.",
        dependencies=("administration.billing",),
        aliases=("quotations", "cotacoes", "quotation", "cotacao"),
    ),
    DomainModuleDefinition(
